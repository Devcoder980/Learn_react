...
const apiData =
  ...
  // array[0].phonetics[2].audio

const audios=new Audio(apiData[0].phonetics[2].audio);
// audios.src=apiData[0].phonetics[2].audio;
function RevistionDay() {
  return (
    <div>
      <img  alt="sdfsd" onClick={()=>{audios.play()}}/>
